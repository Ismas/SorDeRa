...
# Generated: Sun Mar  6 22:42:43 2016
##################################################
...
class SorDeRa_sdr(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blks2_valve_0_0_1 = grc_blks2.valve(item_size=gr.sizeof_gr_complex*1, open=bool(mode!=4 ))
        self.blks2_valve_0_0_0 = grc_blks2.valve(item_size=gr.sizeof_gr_complex*1, open=bool(0))
        self.blks2_valve_0_0 = grc_blks2.valve(item_size=gr.sizeof_gr_complex*1, open=bool(mode!=3))
...
# QT sink close method reimplementation
    ...
    def set_mode(self, mode):
        ...
        self.blks2_valve_0_0.set_open(bool(self.mode!=3))
        self.blks2_valve_0_0_1.set_open(bool(self.mode!=4 ))
